...
class MLP(object):
    ...
    def __init__(self,
             ...
             net_kargs={},
             gpu_ratio=0.2,
             weight_path='data/normalized_weight_map_diatom.mat'):
        ...
        full_weight = spio.loadmat(weight_path)['weight']
        num_blocks = 100
        block_size = 4900
        ...
        self.current_weight_ph = tf.placeholder(tf.float32, shape=[4900, 1])
